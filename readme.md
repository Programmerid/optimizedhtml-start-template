...
<ol>
	<li><a href="https://github.com/Programmerid/optimizedhtml-start-template/archive/master.zip">Download</a> <strong>optimizedhtml-start-template</strong> from GitHub;</li>
